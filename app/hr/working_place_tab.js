function workingPlaceTab() {
    if (Ext.getCmp('working_place_tab')) {
        ...
        var new_tab = tab_panel.add({
            ...
            autoScroll: true,
            items: [
                workingPlaceListToolBar(),
                workingPlaceListGrid()
            ],
            bbar: [{
                xtype: 'button',
                text: 'Reload',
...
function workingPlaceListToolBar() {
                ...
                Ext.create('Ext.window.Window', {
                    ...
                    items: [
                        Ext.create('Ext.form.Panel', {
                            ...
                            border: false,
                            items: [
                                newTextField('Working Place', 'name')
                            ],
                            buttons: [{
                                text: 'Reset',
                                handler: function() {
